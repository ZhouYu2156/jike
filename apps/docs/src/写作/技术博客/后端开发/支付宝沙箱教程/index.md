...
![沙箱配置起始界面](/pictures/支付宝沙箱/沙箱配置起始界面.png)

进入后的界面如下，有两个关键的地方 🛡️ `APPID`和 🔑 `密钥`，之后需要配置到我们的项目中：

![沙箱应用信息](/pictures/支付宝沙箱/沙箱应用信息.png)
