import { ref } from 'vue'
import { ReferenceItems } from './types'
...
export const FrontEndItems = ref<ReferenceItems>([
  ...
  },
  {
    ...
    icon: 'https://www.cssmatic.com/img/cssmatic-logo.svg',
  },
  {
    id: 21,
    title: '文件格式转换',
 ...
 * 设计与调色盘
 */
export const ColorPaletteItems = ref<ReferenceItems>([
  {
    id: 1,
    title: '配色主题',
  ...
  },
  {
    ...
    icon: '/site-icons/lol-colors.svg',
  },
  {
    id: 6,
    title: 'ColorDrop',
  ...
  },
  {
    ...
    icon: '/site-icons/cssgradient.png',
  },
  {
    id: 13,
    title: 'Color Hunt',
...
/** 资源大全 */
export const ResourceItems = ref<ReferenceItems>([
  {
    id: 2,
    title: '在线工具大全',
    link: 'https://tool.lu/',
    icon: '/site-icons/tool.lu.png',
  },
  {
    id: 3,
    title: '实用在线工具',
  ...
  },
  {
    ...
    icon: 'https://cdn.ai138.com/wp-content/uploads/2024/11/cropped-1732291465-1732291465-A-192x192.png',
  },
  {
    id: 6,
    title: 'AI工具网址大全',
...
/** 数字媒体资源 */
export const MediaItems = ref<ReferenceItems>([
  {
    id: 1,
    title: 'Unsplash',
 ...
 * 可视化学习文档
 */
export const VisualizationItems = ref<ReferenceItems>([
  {
    id: 1,
    title: 'Canvas API',
  ...
  },
  {
    ...
    icon: 'https://www.blender.org/wp-content/themes/bthree/assets/icons/favicon-32x32.png',
  },
  {
    id: 5,
    title: 'D3',
 ...
 * 实用开发文档
 */
export const DevelopmentDocumentsItems = ref<ReferenceItems>([
  {
    id: 1,
    title: 'Chrome 扩展程序',
