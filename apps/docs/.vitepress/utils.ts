...
export function generateNav({
  ...
  iconMap = {
    html: '/nav-icons/html.png',
    css: '/nav-icons/css.png',
    scss: '/nav-icons/scss.png',
    javascript: '/nav-icons/javascript.png',
    electron: '/nav-icons/electron.png',
    PhotoShop: '/nav-icons/PhotoShop.png',
    参考文档: '📚',
    生活: '🏠',
    工作: '💼',
    vue: '/nav-icons/vue.png',
    react: '/nav-icons/react.png',
    nestjs: '/nav-icons/nestjs.png',
    nuxtjs: '/nav-icons/nuxtjs.png',
    koa: '/nav-icons/koa.png',
    express: '/nav-icons/express.png',
    mysql: '/nav-icons/mysql.png',
    redis: '/nav-icons/redis.png',
    mongodb: '/nav-icons/mongodb.png',
    centos: '/nav-icons/centos.png',
    Nginx: '/nav-icons/nginx.png',
    Docker: '/nav-icons/docker.png',
    GSAP: '/nav-icons/gsap.png',
    threejs: '/nav-icons/threejs.png',
    OpenAI: '/nav-icons/openai.png',
    nodejs: '/nav-icons/nodejs.png',
    python: '/nav-icons/python.png',
    Blender: '/nav-icons/blender.png',
    D3js: '/nav-icons/d3js.svg',
    濂湘诗词集: '/nav-icons/濂湘诗词集.png',
    濂湘文言大全: '/nav-icons/濂湘文言大全.png',
    世经: '/nav-icons/世经.png',
    常用TS方法: '/nav-icons/常用TS方法.png',
    谷歌浏览器插件: '/nav-icons/谷歌浏览器插件.png',
    VSCode: '/nav-icons/VSCode.png',
    开源工具: '/nav-icons/开源工具.png',
    桌面应用: '/nav-icons/桌面应用.png',
    演示代码: '/nav-icons/演示代码.png',
    桌面开发: '/nav-icons/桌面开发.png',
    支付宝: '/nav-icons/alipay.png',
  },
  titleMap = {
    web开发: '💻 Web开发',
    运维: '🛠️ 运维',
